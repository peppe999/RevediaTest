...
var descOrderBtn;
var allMusicTypeBtn;
var onlySongsTypeBtn;
var onlyAlbumsTypeBtn;
...
var loadTipologyContents = function () {
    startLoading();
    $.ajax({
        url: "/music/explore/numberOfContents",
        method: "GET",
        data: {
            genre: genre,
            type: tipology
...
var resetTipologyBtn = function () {
    allMusicTypeBtn.classList.remove("active-filter");
    onlySongsTypeBtn.classList.remove("active-filter");
    onlyAlbumsTypeBtn.classList.remove("active-filter");
}
...
window.addEventListener("load", function () {
    ...
    allMusicTypeBtn = document.getElementById("all-music-filter-btn");
    allMusicTypeBtn.addEventListener("click", function () {
        if(loading)
            return;
    ...
    onlySongsTypeBtn = document.getElementById("song-filter-btn");
    onlySongsTypeBtn.addEventListener("click", function () {
        if(loading)
            return;
    ...
    onlyAlbumsTypeBtn = document.getElementById("only-album-filter-btn");
    onlyAlbumsTypeBtn.addEventListener("click", function () {
        if(loading)
            return;
