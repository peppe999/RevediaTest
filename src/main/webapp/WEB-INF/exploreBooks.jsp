...
<head>
    ...
    <title>Revedia - Libri ${genre}</title>
...
<body>
     ...
     <div class="genre-page-info-section" style="background-image: url(&quot;/images/bts-getty.jpg&quot;);">
        <div class="genre-page-info-section-cover">
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <h1 class="genre-page-info-section-cat-lbl">Libri</h1>
                        <h1 class="genre-page-info-section-genre-lbl">${genre}</h1>
                        <h1 class="genre-page-info-section-num-lbl">${countBooks} libri</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col block-col">
                    <div class="row">
                        <div class="col align-self-center">
                            <h2 class="section-title"><i class="fa fa-star section-title-icon"></i>Libri migliori del genere</h2>
                        </div>
                    </div>
    ...
    <script src="/js/exploreBooksLoader.js"></script>
