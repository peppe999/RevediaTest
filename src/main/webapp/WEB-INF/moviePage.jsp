    ...
    <div class="card explore-card content-page-main-card">
        <div class="card-body">
            <div class="card-info">
                ...
                <h6 class="text-muted card-subtitle mb-2"><i class="fa fa-user card-icon user-icon"></i><c:out value="${movie.user}"/></h6>
                <h6 class="text-muted card-subtitle mb-2 last-subtitle"><i class="fa fa-spinner card-icon"></i>${movie.postDate}</h6>
                <h1 class="text-nowrap text-truncate card-title card-title-xl"><c:out value="${movie.title}"/></h1>
                <div class="content-page-info-section">
                    ...
                    <h4 class="text-nowrap text-truncate card-title info-lbl">${movie.length}</h4>
                </div>
                <div class="content-page-info-section">
                    <h5 class="info-header-lbl"><i class="fa fa-info-circle section-title-icon genre-icon"></i>Genere</h5>
                    <h4 class="text-nowrap text-truncate card-title info-lbl"><c:out value="${movie.genres}"/></h4>
                </div>
                <div class="content-page-info-section">
