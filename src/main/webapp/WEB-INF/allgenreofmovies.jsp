...
<head>
    ...
    <title>Revedia - Film <%= request.getParameter("genre") %></title>
    ...
    <div style="/*padding: 40px;*/background: url(&quot;images/bts-getty.jpg&quot;) center / cover no-repeat;box-shadow: rgba(66, 66, 66, 0.5) 0px 2px 10px -4px;">
        <div style="padding: 40px;height: 100%;backdrop-filter: blur(5px);background: linear-gradient(90deg, rgba(214,89,55,0.65) 0%, rgba(222,147,0,0.65) 100%);">
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <h1 style="/*display: inline-block;*/color: #f0f0f0;font-size: 18px;margin-bottom: 6px;font-weight: 600;">Film</h1>
                        ...
                        <h1 style="/*display: inline-block;*/color: #f0f0f0;font-size: 14px;margin-bottom: 0;font-weight: 500;">${countMovies} Film</h1>
                    </div>
                </div>
            </div>
        </div>
