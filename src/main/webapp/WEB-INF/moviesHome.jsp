    ...
    <div class="container-fluid pulse animated">
        <div class="row">
            <div class="col align-self-center filter-col">
                <h2 class="section-title"><i class="fa fa-film section-title-icon movie-page-icn"></i>Generi di film<a id="filter-btn" href="#filterarea" data-toggle="collapse" aria-expanded="true" aria-controls="filterarea" role="button"><i class="fa fa-caret-down"></i></a></h2>
            </div>
        </div>
        <div class="row collapse show" id="filterarea">
            <c:forEach var="genre" items="${genreList}">
                <div class="col genre-col">
                    <div class="card genre-card"><a class="genre-card-link" href="movies/explore?genre=${genre}"></a>
                        <div class="card-body">
                            <div class="card-info">
    ...
    <div class="container-fluid pulse animated">
        <div class="row">
                            ...
                            <div class="card home-card">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        ...
                                        <h4 class="card-title">${bestMoviesList[index].title}</h4>
            ...
            <div class="col block-col">
                <div class="row">
                    <div class="col align-self-center">
                        <h2 class="section-title"><i class="fa fa-calendar section-title-icon"></i>Film più recenti</h2>
                    </div>
                </div>
                <c:forEach var="index" begin="0" end="3">
                    <c:if test="${index % 2 == 0}">
                            ...
                            <div class="card home-card">
                                <div class="card-body">
                                    ...
                                    <div class="card-info">
                                        ...
                                        <h4 class="card-title">${latestMoviesList[index].title}</h4>
